...
export ZSH=/Users/auka/.oh-my-zsh
...
# Go down a directory, if there is a single directory, keep going. If there is more than 1 file/directory, stop.
# this is useful for going through Java folders.
function scd()
{
	START=`pwd`
	cd $1 || exit 1
